...
namespace 酒店管理系统
{
	public class RoomType : 医院管理系统.ParentForm
	{
		...
		private System.Data.SqlClient.SqlConnection da;
		...
		private void InitializeComponent()
		{
            ...
            this.da = new System.Data.SqlClient.SqlConnection();
            ...
            // da
            // 
            this.da.ConnectionString = "workstation id=localhost;Integrated Security=SSPI;Database=hotelbook;";
            this.da.FireInfoMessageEventOnUserErrors = false;
            // 
            // sqlSelectCommand1
            // 
            this.sqlSelectCommand1.CommandText = "SELECT 类型编号, 类型名称, 价格, 拼房价格, 可超预定数, 是否可拼房 FROM 客房类型 WHERE (类型编号 LIKE @Param3) AND" +
                " (类型名称 LIKE @Param4)";
            this.sqlSelectCommand1.Connection = this.da;
            ...
            this.sqlInsertCommand1.CommandText = "INSERT INTO 客房类型(类型编号, 类型名称, 价格, 拼房价格, 可超预定数, 是否可拼房) VALUES (@类型编号, @类型名称, @价格, @" +
                ...
                " (类型编号 = @类型编号)";
            this.sqlInsertCommand1.Connection = this.da;
            ...
            this.sqlUpdateCommand1.Connection = this.da;
            ...
            this.sqlDeleteCommand1.Connection = this.da;
